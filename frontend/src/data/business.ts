/**
 * Real business details for Anandi Sarees. Update as remaining client info
 * (address, GST, logo, brand colors, policies) is provided.
 */
export const BUSINESS = {
  name: "Anandi Sarees",
  ownerName: "Swanandi Potdar",
  phone: "+91 91465 00080",
