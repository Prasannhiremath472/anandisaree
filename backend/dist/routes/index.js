...
const productTag_routes_1 = __importDefault(require("./productTag.routes"));
...
router.get("/admin/dashboard", auth_1.authenticate, (0, auth_1.authorize)(...roles_1.ADMIN_ROLES), orderController.getDashboardSummary);
...
router.use("/admin/reels", reel_routes_1.default);
router.use("/admin/product-tags", productTag_routes_1.default);
